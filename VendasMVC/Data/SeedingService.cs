...
namespace VendasMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d1 = new Department(1, "Periféricos");
            Department d2 = new Department(2, "Eletrônicos");
            Department d3 = new Department(3, "Roupas");
            Department d4 = new Department(4, "Livros");

            Seller s1 = new Seller(1, "John Snow", "johwsnow@gmail.com", new DateTime(1992, 5, 12), 1500.0, d1);
            ...
            SalesRecord r1 = new SalesRecord(1, new DateTime(2023, 03, 25), 11000.0, SaleStatus.Billed, s1);
            ...
            SalesRecord r26 = new SalesRecord(26, new DateTime(2023, 05, 6), 5000.0, SaleStatus.Billed, s4);
            SalesRecord r27 = new SalesRecord(27, new DateTime(2023, 05, 13), 9000.0, SaleStatus.Pending, s1);
